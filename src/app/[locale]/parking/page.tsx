        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="space-y-4">
                    ...
                    {getPositionsForSelectedTrack().map((position) => {
                      ...
                      return (
                        ...
                        >
                          {t('position')} {position}
                          {isOccupied
                            ? ` (${t('occupiedBy', { trainId: occupyingTrain?.train_id || '' })})`
                            : ` (${t('available')})`}
                        </option>
                      );
                    })}
              ...
              >
                {isEditing ? `🔄 ${t('updateAssignment')}` : `📍 ${t('assignButton')}`}
              </button>
                      ...
                      <div className="space-y-2">
                        {track.positions.map((position) => {
                          ...
                          return (
                            <div
                              key={position}
                              className={`p-3 rounded-lg text-center border transition-all duration-300 ${assignment
                            ...
                            >
                              ...
                              {assignment ? (
                                ...
                                <div className="text-sm mt-1">{t('available')}</div>
                              )}
                            </div>
                          );
                        })}
                    ...
                    >
                      ...
                      {track.positions.map((position) => {
                        ...
                        return (
                          <div
                            key={position}
                            className={`p-3 rounded-lg text-center border transition-all duration-300 min-h-[80px] flex flex-col justify-center ${assignment
