...
const createInitialTrains = (): TrainData[] => {
  const trainsData = [
    { id: 'TM010', position: 'PT02', slot: 1, scheduledTime: '07:30', condition: 'excellent', urgency: 2, ma: 850, nextTrain: 'TM014', distance: 2100, priority: true },
    { id: 'TM014', position: 'PT06', slot: 2, scheduledTime: '07:40', condition: 'excellent', urgency: 1, ma: 920, nextTrain: 'TM021', distance: 2300, priority: true },
    { id: 'TM021', position: 'PT01', slot: 3, scheduledTime: '07:50', condition: 'excellent', urgency: 0, ma: 880, nextTrain: 'TM019', distance: 1950, priority: true },
    { id: 'TM019', position: 'PT03', slot: 4, scheduledTime: '08:00', condition: 'excellent', urgency: 0, ma: 900, nextTrain: 'TM013', distance: 2050, priority: false },
    { id: 'TM013', position: 'PT05', slot: 5, scheduledTime: '08:10', condition: 'excellent', urgency: 0, ma: 875, nextTrain: 'TM009', distance: 2100, priority: false },
    { id: 'TM009', position: 'PT04', slot: 6, scheduledTime: '08:20', condition: 'excellent', urgency: 0, ma: 890, nextTrain: 'TM023', distance: 2200, priority: false },
    { id: 'TM023', position: 'PT07', slot: 7, scheduledTime: '08:30', condition: 'good', urgency: 0, ma: 820, nextTrain: 'TM020', distance: 1850, priority: false },
    { id: 'TM020', position: 'PT10', slot: 8, scheduledTime: '08:40', condition: 'moderate', urgency: 0, ma: 780, nextTrain: 'TM001', distance: 1900, priority: false },
    { id: 'TM001', position: 'PT08', slot: 9, scheduledTime: '08:50', condition: 'moderate', urgency: 0, ma: 790, nextTrain: 'TM008', distance: 1950, priority: false },
    { id: 'TM008', position: 'PT09', slot: 10, scheduledTime: '09:00', condition: 'moderate', urgency: 0, ma: 770, nextTrain: null, distance: null, priority: false }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="mb-8">
        ...
        {/* Track Visualization */}
        <div className="relative h-64 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-4 overflow-hidden border border-gray-700">
          {/* Track line */}
          ...
          {trains.map((train, index) => {
            ...
            return (
              <div
                key={train.id}
                className={`absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2 transition-all duration-${updateInterval} ${
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {trains.map((train) => {
            ...
            return (
              <div
                key={train.id}
                className={`relative rounded-xl p-4 cursor-pointer transform transition-all hover:scale-105 ${
                  isViolation
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 rounded-lg bg-gray-900/50">
                ...
                <span className={`font-bold ${
                  Math.min(...trains.map(t => t.distanceToNext)) < METRO_CONFIG.MIN_SEPARATION * 1.5 
                    ? 'text-red-400' 
                    : 'text-green-400'
                }`}>
        ...
        <div className="fixed right-0 top-0 h-full w-96 bg-gradient-to-b from-gray-800 to-gray-900 border-l border-teal-500/30 shadow-2xl transform transition-all duration-300 z-50">
          <div className="p-6 h-full overflow-y-auto">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-700/30 rounded-lg">
              ...
              <span className={`font-bold ${
                selectedTrain.urgency === 2 ? 'text-red-400' :
