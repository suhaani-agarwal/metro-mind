      ...
      <div className="max-w-6xl mx-auto p-8 space-y-8">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            <div
              className={`flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-300 ${step >= 1
            ...
            <div
              className={`w-16 h-1 rounded-full transition-all duration-300 ${step >= 2 ? "bg-emerald-400" : "bg-slate-600"
                }`}
            ></div>
            <div
              className={`flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-300 ${step >= 2
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center pt-8">
                <button
                  ...
                  onClick={submitDepot}
                  className={`px-8 py-4 text-lg font-semibold text-slate-50 rounded-2xl border border-transparent transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-emerald-400/20 backdrop-blur-sm ${loading || !isDepotValid()
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center pt-8">
                <button
                  ...
                  className={`px-8 py-4 text-lg font-semibold text-slate-50 rounded-2xl border border-transparent transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-sky-400/20 backdrop-blur-sm ${loading ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                  style={{
                    background: loading
                      ? "rgba(100, 116, 139, 0.5)"
