...
// // Realistic Metro Train Car 3D Component
// function TrainCar({ position }: { position: [number, number, number] }) {
//   const groupRef = useRef<THREE.Group>(null);
...
//       {/* Windows */}
//       {[...Array(4)].map((_, idx) => (
//         <mesh key={idx} position={[-1 + idx * 1, 0.15, 0.52]}>
...
//       {/* Doors */}
//       {[0, 3].map((xPos) => (
//         <mesh key={xPos} position={[xPos - 1.5, -0.1, 0.52]}>
...
//       {/* Wheels */}
//       {[[-1, -0.6], [1, -0.6]].map(([x, z], idx) => (
//         <mesh key={idx} position={[x, -0.65, z]}>
...
// // Metro Platform & Train with rotation
// function Metro3DFeature() {
//   const groupRef = useRef<THREE.Group>(null);
...
//     <group ref={groupRef} position={[0, 0, 0]} castShadow>
//       {/* Platform */}
//       <mesh position={[platformLength / 2 - 1, -0.6, 0]}>
//         <boxGeometry args={[platformLength, 0.5, platformWidth]} />
//         <meshStandardMaterial color="#708090" />
//       </mesh>

//       {/* Rails */}
//       <mesh position={[platformLength / 2 - 1, -0.2, railSpacing / 2]}>
//         <boxGeometry args={[platformLength, railHeight, railWidth]} />
...
//       {/* Train Cars in Color */}
//       {colors.map((color, index) => (
//         <TrainCar key={index} position={[index * 2.6, 0, 0]} />
//       ))}

//       {/* Label */}
//       <Text fontSize={0.5} color="#0ea5e9" position={[platformLength / 2 + 1, 1, 0]}>
//         Kochi Metro
//       </Text>
//     </group>
//   );
...
// // Features with icon and color (used for cards)
// const featuresMetro = [
//   {
//     title: "Real-Time Data Ingestion",
//     description:
...
//   {
//     title: "3D Yard Simulation",
//     description: "Drag-and-drop depot view for testing scenarios and minimizing shunting time.",
//     icon: Shield,
//     color: "#0369a1",
//   },
// ];

// // Metro card glow style
// const metroGlow = "shadow-[0_0_28px_0_rgba(14,165,233,0.3)] ring-2 ring-blue-400";
...
//             playsInline
//             className="w-100 h-100 object-fit-cover"
//             style={{ filter: "blur(8px) brightness(0.5)", objectPosition: "center" }}
//           />
//           <div
//             className="position-absolute w-100 h-100"
//             style={{ top: 0, left: 0, background: "rgba(0, 0, 0, 0.4)", zIndex: 1 }}
//           />
//         </div>
//         <Container className="position-relative z-2">
//           <Row className="align-items-center">
//             <Col lg={8} className="mb-5 mb-lg-0">
//               <h1 className="fw-bold mt-3" style={{ fontSize: "4rem", lineHeight: "1.2" }}>
//                 <span className="text-primary" style={{ fontSize: "4.5rem" }}>
//                   MetroMind
//                 </span>
//                 <br />
//                 The Brain Behind
...
//                 Every Train Move
//               </h1>
//               <p className="mt-4" style={{ fontSize: "1.5rem", color: "#d3d3d3" }}>
//                 Smart Train Induction & Scheduling System for Kochi Metro. <br />
//                 Revolutionizing metro operations with AI-powered optimization and real-time intelligence.
//               </p>
//               <div className="d-flex flex-column flex-sm-row gap-3 mt-5">
//                 <Button variant="primary" className="d-flex align-items-center px-4 py-3 fs-5">
//                   Access Dashboard <ArrowRight className="ms-2" />
//                 </Button>
//                 <Button variant="outline-light" className="d-flex align-items-center px-4 py-3 fs-5">
//                   <Play className="me-2" /> Watch Demo
//                 </Button>
//               </div>
//             </Col>
...
//           <h2 className="text-center mb-5 fw-bold text-blue-900">Features</h2>
//           <div className="row g-4 items-center">
//             <div className="col-lg-6 h-[350px] sm:h-[400px] md:h-[380px] relative z-10">
//               {/* 3D Metro Visualization */}
//               <Canvas shadows camera={{ position: [7, 4, 6], fov: 40 }}>
...
//                 <motion.div
//                   key={feature.title}
//                   className={`card mb-4 rounded-lg p-5 bg-white border-0 cursor-pointer ${metroGlow}`}
//                   initial={{ opacity: 0, y: 60 }}
//                   animate={{ opacity: 1, y: 0 }}
//                   whileHover={{ scale: 1.07 }}
//                   transition={{ delay: idx * 0.2, duration: 0.6 }}
...
//       {/* Workflow Section */}
//       <section id="workflow" className="relative min-h-screen bg-gradient-to-b from-white to-gray-50 py-24">
//         <Container className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
//           <motion.h2
//             initial={{ opacity: 0, y: 20 }}
//             whileInView={{ opacity: 1, y: 0 }}
...
//                 <div className="absolute inset-0 flex flex-col justify-between py-2">
//                   {Array.from({ length: 20 }).map((_, i) => (
//                     <div key={i} className="w-6 h-1 bg-gray-600 mx-auto rounded-sm" />
//                   ))}
//                 </div>
//               </div>
//               <motion.div
...
//       <section style={{ backgroundColor: "#f8f9fa", padding: "4rem 0" }}>
//         <div
//           className={`metro-card-elevated p-8 border-primary/20 ${isVisible ? "metro-animate-slide-up animate-in" : "metro-animate-slide-up"}`}
//           style={{ animationDelay: "1.2s" }}
//         >
//           <div className="text-center">
//             <h3 className="text-2xl font-bold text-foreground mb-4">Continuous Learning & Optimization</h3>
//             <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
//               Every supervisor override and operational decision feeds back into our AI system,
//               making MetroMind smarter and more efficient with each passing day.
//             </p>
//             <div className="flex justify-center space-x-8">
//               <div className="text-center">
//                 <div className="text-2xl font-bold text-primary">24/7</div>
...
//       {/* Footer */}
//       <footer style={{ backgroundColor: "#f2f2f2", color: "#333", borderTop: "1px solid #ddd", paddingTop: "2rem", paddingBottom: "2rem" }}>
//         <Container>
//           <Row className="mb-4">
//             <Col md={4} className="mb-3">
//               <div className="d-flex align-items-center mb-2">
//                 <div
//                   style={{ background: "linear-gradient(to bottom right, #00bfff, #87cefa)", width: 40, height: 40, borderRadius: "50%" }}
//                   className="d-flex align-items-center justify-content-center"
//                 >
//                   <strong style={{ color: "#fff", fontSize: "1.25rem" }}>M</strong>
//                 </div>
//                 <h5 className="ms-2 mb-0" style={{ color: "#333", fontWeight: "600" }}>
//                   MetroMind
//                 </h5>
//               </div>
//               <p style={{ color: "#666", fontSize: "0.9rem", maxWidth: "280px" }}>
//                 The Brain Behind Every Train Move. Smart scheduling & induction system for efficient metro operations.
//               </p>
//             </Col>
//             <Col md={2} className="mb-3">
//               <h6 style={{ color: "#444", fontWeight: "600" }}>Quick Links</h6>
...
//             </Col>
//             <Col md={4} className="mb-3">
//               <h6 style={{ color: "#444", fontWeight: "600" }}>Contact Us</h6>
//               <div style={{ fontSize: "0.9rem", color: "#666" }}>
//                 <div className="d-flex align-items-center mb-2">
//                   <Mail size={16} className="me-2" style={{ color: "#00bfff" }} />
//                   <span>support@metromind.kochi</span>
...
//             </Col>
//           </Row>
//           <div className="d-flex flex-column flex-md-row justify-content-between align-items-center" style={{ borderTop: "1px solid #ddd", paddingTop: "1rem" }}>
//             <p style={{ color: "#666", fontSize: "0.8rem", margin: 0 }}>© {currentYear} MetroMind. All rights reserved.</p>
//             <div className="mt-2 mt-md-0">
//               <a href="/privacy" style={{ color: "#666", marginRight: "1rem", fontSize: "0.8rem", textDecoration: "none" }}
//                onMouseEnter={(e) => (e.currentTarget.style.color = "#00bfff")}
//                onMouseLeave={(e) => (e.currentTarget.style.color = "#666")}
//               >Privacy Policy</a>
//               <a href="/terms" style={{ color: "#666", fontSize: "0.8rem", textDecoration: "none" }}
//                onMouseEnter={(e) => (e.currentTarget.style.color = "#00bfff")}
//                onMouseLeave={(e) => (e.currentTarget.style.color = "#666")}
//               >Terms of Service</a>
//             </div>
